...
| 21 | ❤️ Список обраних | 🔄 Заплановано | Wishlist |
| 22 | 🏷️ Промокоди | 🔄 Заплановано | Система знижок |
| 23 | 🧪 Unit тести | 🔄 Заплановано | `tests/` |
...
```mermaid
timeline
    title Версії SilpoMarket
    2026-07-03 : v1.0.0 Initial Release
               : 504 товари
               : SQLite авторизація
               : Темна та світла тема
    2026-07-04 : v1.1.0 Wallet Update
               : Гаманець і поповнення
               : Вікно банківської оплати
    2026-07-04 : v1.2.0 Payment & UX
               : 3 способи оплати
               : Автозаповнення форм
               : Преміум HTML чеки
    Майбутнє   : v2.0.0 Planned
               : Wishlist обраних
               : Промокоди та знижки
               : Unit тести
```
