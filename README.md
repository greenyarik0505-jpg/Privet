...
```
  ...
  █   🌍  3 МОВИ ІНТЕРФЕЙСУ      ⭐  ВІДГУКИ ТА РЕЙТИНГИ   █
  █   🎨  ТЕМНА / СВІТЛА ТЕМА    🧾  HTML ЧЕК ЗАМОВЛЕННЯ   █
  █   ⚡  ПОШУК БЕЗ ЗАТРИМОК     💰  ГАМАНЕЦЬ БАЛАНСУ      █
  █   📦  ФОНОВИЙ ЗАВАНТАЖУВАЧ   📜  ІСТОРІЯ ЗАМОВЛЕНЬ     █
  █                                                          █
  ████████████████████████████████████████████████████████████
```
...
![Деталі товару](screenshot_details_v6.png)
...
| 📦 Товарів | 🗂️ Категорій | 💾 Рядків коду | 🌍 Мов | 🎨 Тем |
|:----------:|:------------:|:--------------:|:------:|:------:|
| **504** | **7** | **1600+** | **3** | **2** |
...
### 🌍 Мультимовність та Теми

```
┌─────────────────────────────────────────────────────────────────┐
│  🇺🇦  Українська — основна мова інтерфейсу                      │
│  🇬🇧  English — повний переклад всього UI                        │
│  🇷🇺  Русский — повний переклад всього UI                        │
...
Privet/
│
├── main.py                    # 🚀 Головний файл застосунку (1600+ рядків)
...
│   ├── cat_meat_fish.png      # Іконка категорії М'ясо & Риба
...
│
├── screenshot_main_v6.png     # 📷 Скріншот головного екрану
├── screenshot_details_v6.png  # 📷 Скріншот деталей товару
├── screenshot_cart_v6.png     # 📷 Скріншот кошика
...
|-------|----------|-------|
| 🌍 Мова | Українська / English / Русский | Перекладає весь інтерфейс |
...
| 4 | 🌍 3 мови (UA / EN / RU) | ✅ Готово | Миттєве перемикання без перезапуску |
